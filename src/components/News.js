...
const News =(props)=> {
  ...
  const updateNews= async()=>{
      ...
      const url =`https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=df8c4d5534624a23bd39be98d5aabd5e&page=${page}&pageSize=${props.pageSize}`;
      setLoading(true);
        ...
        <div className="row">
            {articles.map((element)=>{
                ...
                <NewsItems
                  ...
                  imageUrl={element.urlToImage} newsUrl={element.url} author={element.author} date=
